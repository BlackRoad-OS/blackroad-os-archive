...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-os-archive.git
cd blackroad-os-archive

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-os-archive.git
